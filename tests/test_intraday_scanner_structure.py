...
# mark_source added 2026-09-15: LiveChainPricer now refuses a structure whose
# legs were struck at different moments. These fixtures set `mid`, i.e. they
# describe QUOTED contracts, and a quote midpoint is the current price — so
# they are exempt from the last-trade freshness rule rather than needing a
# timestamp. Staleness itself is covered by tests/test_entry_price_freshness.py.
...
def test_build_intraday_structure_enriches_setup():
    ...
    chain = _chain([
        {"type": "put",  "strike": 497.0, "mid": 1.20, "mark": 1.20, "mark_source": "quote_mid", "expiration": "2026-06-01"},
        {"type": "put",  "strike": 492.0, "mid": 0.40, "mark": 0.40, "mark_source": "quote_mid", "expiration": "2026-06-01"},
        {"type": "call", "strike": 503.0, "mid": 1.10, "mark": 1.10, "mark_source": "quote_mid", "expiration": "2026-06-01"},
        {"type": "call", "strike": 508.0, "mid": 0.35, "mark": 0.35, "mark_source": "quote_mid", "expiration": "2026-06-01"},
    ])
